...
from atlas.core.models import Level
from atlas.user.tests.test_user_api import create_user
...
class PublicLevelApiTests(TestCase):
    ...
    def setUp(self):
        ...
        self.url = reverse('level:level-list')
...
class UpdateLevelApiTests(TestCase):
    ...
    def setUp(self):
        ...
        self.url = reverse('level:level-detail', args=[self.level.id])
